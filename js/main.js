...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (savedTheme === "dark") {
        ...
        themeSwitcher.textContent = "🌙";  // Mostrar luna cuando está en modo oscuro
    } else {
        themeSwitcher.textContent = "🌞";  // Mostrar sol cuando está en modo claro
    }
    ...
    themeSwitcher.addEventListener("click", () => {
        ...
        themeSwitcher.textContent = isDark ? "🌙" : "🌞";  // Sol o luna
    });
});
